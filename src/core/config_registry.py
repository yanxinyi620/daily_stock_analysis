...
WEB_SETTINGS_HIDDEN_FROM_UI = {
    # Trusted publisher deployment settings; not local Web settings fields.
    "SUPABASE_PUBLISH_ENABLED",
    "SUPABASE_URL",
    "SUPABASE_SECRET_KEY",
    "SUPABASE_PUBLISH_USER_ID",
    "SUPABASE_PUBLISH_TIMEOUT",
    "ENABLE_ACTIONS_DISPATCH",
    "CLOUD_RUNNER_DATABASE_URL",
    "CLOUD_RUNNER_ID",
    "CLOUD_RUNNER_HEARTBEAT_SECONDS",
